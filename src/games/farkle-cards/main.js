...
const MAX_TAPS = 6;       // redirect to store after this many taps

const appleStoreUrl  = 'https://apps.apple.com/us/app/farkle-cards/id6743129505';
const googlePlayUrl  = 'https://play.google.com/store/apps/details?id=com.funcraft.farklecards';
...
async function startGame() {
  ...
  await document.fonts.load('bold 16px MuseoSansRounded').catch(() => {});

  const css = getComputedStyle(document.documentElement);
  const bgColor = css.getPropertyValue('--game-bg-color').trim() || '#00895d';
