...
const MAX_TAPS = 15;       // redirect to store after this many taps
const GAME_FIXED = false;   // when true, dice always roll a matchable board value

const appleStoreUrl = 'https://apps.apple.com/us/app/dice-connect-sequence-twist/id6757721756';
const googlePlayUrl = 'https://play.google.com/store/apps/details?id=com.funcraft.diceconnect';
...
function createLoader() {
  ...
  el.style.cssText =
    'position:fixed;inset:0;background:#9ca9fe;display:flex;' +
...
async function startGame() {
  ...
  const bgColor = css.getPropertyValue('--game-bg-color').trim() || '#9ca9fe';
